...
class Scroll3 extends StatelessWidget {
  const Scroll3({Key? key}) : super(key: key);
  ...
  Widget _repetido(String imagen,
      {required String textmain,
      required String textsecun,
      required String textmoney,
            ...
            Column(
              ...
              children: [
                Container(
                    ...
                    child: CircleAvatar(
                        radius: 16, backgroundImage: NetworkImage(imagen)))
              ],
            ),
            Column(
              mainAxisAlignment: MainAxisAlignment.center,
